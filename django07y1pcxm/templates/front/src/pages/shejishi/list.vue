		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.shejishizhanghao" placeholder="设计师账号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">设计师姓名：</div>
					<el-input v-model="formSearch.shejishixingming" placeholder="设计师姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('shejishi','新增')" type="primary" @click="add('/index/shejishiAdd')">
			...
			<div class="list">
				...
				<div class="list list4 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item">
						...
						<div class="content">
							<div class="infoBox">
								<div class="name">{{item.shejishixingming}}</div>
								<div class="name">{{item.xingbie}}</div>
								<div class="name">擅长风格:{{item.shanzhangfengge}}</div>
								<div class="time_item">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.shejishizhanghao != '') searchWhere.shejishizhanghao = '%' + this.formSearch.shejishizhanghao + '%';
				if (this.formSearch.shejishixingming != '') searchWhere.shejishixingming = '%' + this.formSearch.shejishixingming + '%';
				let user = JSON.parse(localStorage.getItem('sessionForm'))
				if (this.sortType) searchWhere.sort = this.sortType
				if (this.sortOrder) searchWhere.order = this.sortOrder
				this.$http.get(`shejishi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/shejishiDetail', query: params});
			},
