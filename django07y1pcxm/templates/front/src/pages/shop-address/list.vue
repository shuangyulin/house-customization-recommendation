<template>
	<div :style='{"padding":"0 calc((100% - 1200px)/2) 20px","margin":"0px auto","color":"#666","background":"#fff","width":"100%","fontSize":"16px","position":"relative"}'>
		...
		<div class="section-title" :style='{"padding":"0","margin":"20px 0 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20241228/f151b89f53c94b7fa5ae510c2f7bd563.png) no-repeat center bottom","width":"100%","fontSize":"32px","lineHeight":"100px","position":"relative","height":"191px"}'>我的地址</div>
